...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_storage_storage__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__card_list_card_list__ = __webpack_require__(198);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CategoriesPage = (function () {
    ...
    CategoriesPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_storage_storage__["a" /* StorageProvider */]])
    ], CategoriesPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__slides_slides__ = __webpack_require__(199);
...
var SlidesPage = (function () {
    function SlidesPage(navCtrl, navParams, storage) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.storage = storage;
        this.slides = [];
    ...
    SlidesPage.prototype.enableCardInput = function (event, Item) {
        this.inputEnabled = true;
    };
    SlidesPage.prototype.updateSlides = function (msg) {
        var _this = this;
        this.storage.getDatabyKey(this.key).then(function (data) {
            console.log("Slides Data = " + JSON.stringify(data));
            _this.slides = data;
            console.log("Number of slides : " + _this.slides.length);
            for (var _i = 0, _a = _this.slides; _i < _a.length; _i++) {
                var slide = _a[_i];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_card_list_card_list__ = __webpack_require__(198);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_categories_categories__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_slides_slides__ = __webpack_require__(199);
...
var SlideInputComponent = (function () {
    function SlideInputComponent(storage) {
        this.storage = storage;
        this.inputSlide = {
            title: "",
            content: '',
    ...
    SlideInputComponent.prototype.addSlide = function () {
        var _this = this;
        console.log("Input key is ADD : " + this.key);
        console.log("Data received : " + JSON.stringify(this.data));
        ...
        this.storage.addCardDetails(this.key, this.slide, this.data).then(function (data) {
            if (data != null) {
                console.log("Content Added :" + JSON.stringify(data));
                _this.onNewData.emit(_this.msg);
            }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Output */])(),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0__angular_core__["v" /* EventEmitter */])
    ], SlideInputComponent.prototype, "onNewData", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", String)
    ], SlideInputComponent.prototype, "key", void 0);
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["D" /* Input */])(),
        __metadata("design:type", Array)
    ], SlideInputComponent.prototype, "data", void 0);
    SlideInputComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'slide-input',template:/*ion-inline-start:"/Users/adprasad/Code/Apps/CardsAndSlides/src/components/slide-input/slide-input.html"*/'<form (ngSubmit)="addSlide()">\n  <h3>{{key}}</h3>\n    <ion-item>\n      <ion-label floating>Slide Title</ion-label>\n      <ion-input type="text" [(ngModel)]="inputSlide.title" name="title"></ion-input>\n    </ion-item>\n    <ion-item>\n      <ion-label floating>Description</ion-label>\n      <ion-textarea [(ngModel)]="inputSlide.content" name="content"></ion-textarea>\n    </ion-item>\n    \n    <button ion-button type="submit">Add Slide</button>\n  </form>\n'/*ion-inline-end:"/Users/adprasad/Code/Apps/CardsAndSlides/src/components/slide-input/slide-input.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__providers_storage_storage__["a" /* StorageProvider */]])
    ], SlideInputComponent);
